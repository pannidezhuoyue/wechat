...
rightData = {
    ...
    'question_6': 'option_6_2',
    'question_7': 'option_7_3',
    'question_8': 'option_8_4',
    'question_9': 'option_9_1',
    'question_10': 'option_10_2',
    'question_11': 'option_11_1',
    'question_12': 'option_12_2',
    'question_13': 'option_13_1',
    'question_14': 'option_14_2',
    'question_15': 'option_15_1',
    'question_16': 'option_16_2',
    'question_17': 'option_17_1',
    'question_18': 'option_18_2',
    'question_19': 'option_19_1',
    'question_20': 'option_20_2',
    'question_21': 'option_21_1,option_21_2',
    'question_22': 'option_22_1,option_22_2',
    'question_23': 'option_23_1,option_23_2',
    'question_24': 'option_24_1,option_24_2',
    'question_25': 'option_25_1,option_25_2',
};
point = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4];
window.onload = function() {
    //cooike回复考生答案
    var answer = $.getCookie("exam_2");
    if (answer != '') {
...
function countdownSubmit() {
    ...
    if (countdown <= 1) {
        $.MsgBox.Confirm1('提示','考试时间结束',submitPaper);
    } else {
...
function getAnswer(nead) {
    ...
    $.setCookie("exam_2", JSON.stringify(data), 10);
    if (nead) {
        return data;
    }
}
